 ...
 * @author User
 */
public class AIF184341Test {
    /**
     * method testCheckPrasyarat ini untuk mengetes jika mahasiswa boleh mengambil matakuliah Penambangan Data
     */
    @Test
    public void testCheckPrasyarat() {
        AIF182101 asd = new AIF182101();
        AIF184341 datmin = new AIF184341();
        ...
        boolean expRes = true;
        boolean res = datmin.checkPrasyarat(mahasiswa, reasonsContainer);
        assertEquals(expRes, res);
    }
    /**
     * method testCheckPrasyarat2 ini untuk mengetes jika mahasiswa belum boleh mengambil matakuliah Penambangan Data
     */
    @Test
