 ...
 * @author ASUS
 */
public class AIF184104Test {
    
    /**
     * Tes cek method cek prasyarat yang berhasil dari kelas AIF184104.
     */
    @Test
    public void testCheckPrasyaratYangBerhasil() {
        AIF182106 daa = new AIF182106();
        AIF184104 bioInspiredComputing = new AIF184104();
        ...
        boolean expRes = true;
        boolean res = bioInspiredComputing.checkPrasyarat(mahasiswa, reasonsContainer);
        assertEquals(expRes, res);
    }
    
    
    /**
     * Tes cek method cek prasyarat yang gagal dari kelas AIF184104.
     */
    @Test
