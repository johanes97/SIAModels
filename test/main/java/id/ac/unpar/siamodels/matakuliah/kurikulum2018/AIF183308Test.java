...
public class AIF183308Test {
    ...
    public AIF183308Test() {
        new AIF183308();//proyekSI_1
    }

    /**
     * Tes cek method cek prasyarat yang berhasil dari kelas AIF183308.
     */
    @Test
    public void testCheckPrasyaratYangBerhasil() {
        ...
        boolean expRes = true;
        boolean res = proyekSI_1.checkPrasyarat(mahasiswa, reasonsContainer);
        assertEquals(expRes, res);
    }
    
    
    /**
     * Tes cek method cek prasyarat yang gagal dari kelas AIF183308.
     */
    @Test
