 ...
 * @author ASUS
 */
public class AIF184108Test {
    
    /**
     * Tes cek method cek prasyarat yang berhasil dari kelas AIF184108.
     */
    @Test
    public void testCheckPrasyaratYangBerhasil() {
        AIF182106 daa = new AIF182106();
        AIF184108 kompresiData = new AIF184108();
        ...
        boolean expRes = true;
        boolean res = kompresiData.checkPrasyarat(mahasiswa, reasonsContainer);
        assertEquals(expRes, res);
    }
    
    
    /**
     * Tes cek method cek prasyarat yang gagal dari kelas AIF184108.
     */
    @Test
