 ...
 * @author ASUS
 */
public class AIF184334Test {
    
    /**
     * Tes cek method cek prasyarat yang berhasil dari kelas AIF184334.
     */
    @Test
    public void testCheckPrasyaratYangBerhasil() {
        AIF182308 psi = new AIF182308();
        AIF184334 siSkalaBesar = new AIF184334();
        ...
        boolean expRes = true;
        boolean res = siSkalaBesar.checkPrasyarat(mahasiswa, reasonsContainer);
        assertEquals(expRes, res);
    }
    
    
    /**
     * Tes cek method cek prasyarat yang gagal dari kelas AIF184334.
     */
    @Test
