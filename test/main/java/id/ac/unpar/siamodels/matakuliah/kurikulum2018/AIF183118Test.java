...
public class AIF183118Test {
    ...
    /**
     * Tes cek method cek prasyarat yang berhasil dari kelas AIF183118.
     */
    @Test
    public void testCheckPrasyaratYangBerhasil() {
        AIF182101 asd = new AIF182101();
        AIF183118 komputasiGeometri = new AIF183118();
        ...
        boolean expRes = true;
        boolean res = komputasiGeometri.checkPrasyarat(mahasiswa, reasonsContainer);
        assertEquals(expRes, res);
    }
    
    
    /**
     * Tes cek method cek prasyarat yang gagal dari kelas AIF183118.
     */
    @Test
