...
public class AIF183227Test {
    ...
    public AIF183227Test() {
        new AIF183227();//pengantarTelkom
    }

    /**
     * Tes cek method cek prasyarat yang berhasil dari kelas AIF183227.
     */
    @Test
    public void testCheckPrasyaratYangBerhasil() {
        AIF182210 pengantarJarkom = new AIF182210();
        AIF183227 pengantarTelkom = new AIF183227();
        ...
        boolean expRes = true;
        boolean res = pengantarTelkom.checkPrasyarat(mahasiswa, reasonsContainer);
        assertEquals(expRes, res);
    }
    
    
    /**
     * Tes cek method cek prasyarat yang gagal dari kelas AIF183227.
     */
    @Test
