...
public class AIF183120Test {
    ...
    public AIF183120Test() {
        new AIF183120();//pemrogramanPermainanKomp
    }

    /**
     * Tes cek method cek prasyarat yang berhasil dari kelas AIF183120.
     */
    @Test
    public void testCheckPrasyaratYangBerhasil() {
        AIF182101 asd = new AIF182101();
        AIF183120 pemrogramanPermainanKomp = new AIF183120();
        ...
        boolean expRes = true;
        boolean res = pemrogramanPermainanKomp.checkPrasyarat(mahasiswa, reasonsContainer);
        assertEquals(expRes, res);
    }
    
    
    /**
     * Tes cek method cek prasyarat yang gagal dari kelas AIF183120.
     */
    @Test
