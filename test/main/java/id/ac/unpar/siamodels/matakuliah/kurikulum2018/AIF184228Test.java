...
public class AIF184228Test {
    ...
    /**
     * Tes cek method cek prasyarat yang berhasil dari kelas AIF184228.
     */
    @Test
    public void testCheckPrasyaratYangBerhasil() {
        AIF183204 jarkom = new AIF183204();
        AIF184228 pemrogramanJaringan = new AIF184228();
        
        Mahasiswa mahasiswa = new Mahasiswa("2018730079");
        MataKuliahFactory mkf = MataKuliahFactory.getInstance();
        MataKuliah mk = mkf.createMataKuliah("AIF183204", 2, "jarkom");
        ...
        boolean expRes = true;
        boolean res = pemrogramanJaringan.checkPrasyarat(mahasiswa, reasonsContainer);
        assertEquals(expRes, res);
    }
    
    
    /**
     * Tes cek method cek prasyarat yang gagal dari kelas AIF184228.
     */
    @Test
