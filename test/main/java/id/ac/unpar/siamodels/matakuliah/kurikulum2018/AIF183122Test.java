...
public class AIF183122Test {
    ...
    /**
     * Tes cek method cek prasyarat yang berhasil dari kelas AIF183122.
     */
    @Test
    public void testCheckPrasyaratYangBerhasil() {
        AIF182101 asd = new AIF182101();
        AIF183122 pemodelanDanSimulasi = new AIF183122();
        ...
        boolean expRes = true;
        boolean res = pemodelanDanSimulasi.checkPrasyarat(mahasiswa, reasonsContainer);
        assertEquals(expRes, res);
    }
    
    
    /**
     * Tes cek method cek prasyarat yang gagal dari kelas AIF183122.
     */
    @Test
