...
public class AIF184224Test {
    ...
    /**
     * Tes cek method cek prasyarat yang berhasil dari kelas AIF184224.
     */
    @Test
    public void testCheckPrasyaratYangBerhasil() {
        AIF183204 jarkom = new AIF183204();
        AIF184224 sistemTerdistribusi = new AIF184224();
        ...
        boolean expRes = true;
        boolean res = sistemTerdistribusi.checkPrasyarat(mahasiswa, reasonsContainer);
        assertEquals(expRes, res);
    }
    
    
    /**
     * Tes cek method cek prasyarat yang gagal dari kelas AIF184224.
     */
    @Test
